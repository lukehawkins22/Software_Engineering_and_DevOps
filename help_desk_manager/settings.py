"""
Django settings for help_desk_manager project.
...
CSRF_TRSUTED_ORIGINS = ['https://it-help-desk.onrender.com','https://*.onrender.com', 'http://127.0.0.1','http://*.onrender.com']
...
WSGI_APPLICATION = 'help_desk_manager.wsgi.application'
